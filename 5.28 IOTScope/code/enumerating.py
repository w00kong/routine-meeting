...
def get_file_list(string):
    #print ("get_file_list function", string)
...
def generator(vendor, model, verbose=False):
    ...
    if verbose:
        print(path_list)
    #print ("A: .//{}//firmware.tar".format(firmware_dir))
    #print ("B: .//{}//firmware".format(firmware_dir))
    firmware_tar_string = get_string(
        make_tar("./{}/firmware.tar".format(firmware_dir), "./{}/firmware".format(firmware_dir)))
    #firmware_tar_string = "./TP-Link/DIR300/firmware"
    #print (len(firmware_tar_string))
    #firmware_tar_string = "./TP-Link/DIR300/firmware"
    #test = firmware_tar_string.strip('\n')
...
if __name__ == "__main__":
    try:
        ...
        os.system("rm ./potentialExist.txt")
        os.system("rm ./infoLeakPages.csv")
        os.system("rm ./*.db3")
    except:
        pass
    '''
