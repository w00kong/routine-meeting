...
def ajaxCgiParams(vendor, model):
    ...
    keywords = set()
    resList = []
    #print ('ajaxCgiParams ->', file_list, cgis)
    for f in file_list:
        for cgi in cgis:
            try:
                ...
                cont = ""
            #print ('ajaxCgiParams ->', f, cgi)
            #print ('cont, rules ->', len(cont), len(rules))
...
if __name__ == "__main__":
    ...
    #vms = ['D-Link DIR868L']
    urlDIct = {"DIR816": "http://192.168.0.1"}
    #urlDIct = {"DAP1320": "http://192.168.0.50"}
    #urlDIct = {"DIR868L": "http://192.168.0.1"}
    #urlDIct = {"WNDR4000": "http://192.168.1.1"}
    firmadyne = False
    #vms = ["Netgear  WNDR4000"]
    for vm in vms:
